...
public class Robot {
	...
	static int assembleX = -1;
	static int assembleY = -1;
	static int archonX;
	static int archonY;
	...
	static int ZOMBIE_APOCALYPSE = 10004;
	...
	public static void setState(RobotController rcIn)
	{
		
		if(gameState != ZOMBIE_APOCALYPSE && rc.getRoundNum() > 100 && rc.getRobotCount() > 15){
			gameState = ZOMBIE_APOCALYPSE;
			System.out.println("zombie state ");
		}
	}
